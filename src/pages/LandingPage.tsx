    ...
    return (
        <div className="min-h-screen bg-white dark:bg-sit-dark text-slate-900 dark:text-slate-50 selection:bg-sit-orange/20 selection:text-sit-orange">
                        ...
                        {currentUser ? (
                            ...
                            >
                                <div className="hidden sm:block text-right">
                                    ...
                                    <p className="text-[10px] font-black uppercase tracking-widest text-sit-orange group-hover:opacity-80 transition-opacity">
                                        Go to Workspace
                                    </p>
                                </div>
                                <ProfileAvatar
                            ...
                            <>
                                <button
                                    onClick={handleCTA}
                                    className="text-sm font-semibold text-slate-600 dark:text-slate-400 hover:text-sit-orange transition-colors hidden sm:block"
                                >
                                    Log in
                                </button>
                                <button
            ...
            <main className="pt-32 md:pt-56">
                ...
                <section className="max-w-7xl mx-auto px-6 mb-24 lg:mb-32">
                    <div className="max-w-4xl mx-auto text-center space-y-10">
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-6 pt-10">
                            <button
                                onClick={handleCTA}
                                className="group w-full sm:w-auto px-10 py-5 bg-sit-orange text-white rounded-2xl font-black text-xl shadow-2xl shadow-sit-orange/30 hover:bg-sit-orange/90 hover:scale-[1.03] active:scale-[0.97] transition-all flex items-center justify-center gap-3"
                            >
                                Start Building Now
                            ...
                            <button
                                ...
                                className="w-full sm:w-auto px-10 py-5 border-2 border-sit-orange/30 text-sit-dark dark:text-sit-light-blue rounded-2xl font-black text-xl hover:bg-sit-orange/5 dark:hover:bg-sit-orange/10 hover:border-sit-orange transition-all text-center"
                            >
                                See How It Works
                            </button>
                        </div>
                    ...
                    <div className="max-w-7xl mx-auto px-6">
                        <div className="text-center mb-16 md:mb-20 space-y-6">
                            ...
                            <p className="text-xl text-slate-500 dark:text-slate-400 max-w-2xl mx-auto font-medium">
                                ...
                                Three principles that drive everything we build.
                            </p>
                        </div>
                    ...
                    <div className="max-w-7xl mx-auto px-6">
                        <div className="grid lg:grid-cols-2 gap-16 items-center">
                            <div className="space-y-8">
                                <span className="text-sit-orange font-black uppercase text-xs tracking-[0.3em] block">Key Differentiator</span>
                                ...
                                <div className="p-8 rounded-[2rem] bg-red-50 dark:bg-red-950/20 border border-red-100 dark:border-red-900/30">
                                    <p className="text-lg text-slate-600 dark:text-slate-400 font-medium leading-relaxed">
                                        When someone falls behind, the system flags them as <span className="text-red-600 dark:text-red-400 font-black">“At Risk”</span> — automatically, objectively, and visibly.
                                    </p>
                                </div>
                                <p className="text-2xl md:text-3xl font-black text-slate-900 dark:text-white">
                                    No confrontations. No guesswork. Just facts.
                                </p>
                                <p className="text-lg font-bold text-sit-orange">We built this because group work should be fair.</p>
                            </div>
                                ...
                                <div className="p-1 rounded-[3.5rem] bg-gradient-to-br from-sit-orange/20 to-sit-half-baked/20 shadow-2xl backdrop-blur-sm">
                                    <div className="bg-sit-dark rounded-[3.3rem] aspect-video md:aspect-[16/10] relative overflow-hidden group-hover:shadow-[0_0_100px_rgba(254,88,35,0.2)] transition-all duration-700 p-8 md:p-12 flex flex-col justify-between">
                                        ...
                                        <div className="absolute inset-0 opacity-40">
                                            ...
                                            <div className="absolute bottom-0 left-0 w-full h-full bg-[radial-gradient(circle_at_30%_70%,_rgba(138,196,199,0.3),_transparent_60%)]" />
                                        </div>
                                        ...
                                        <div className="relative z-10 flex-1 mt-10 flex items-end gap-1.5">
                                            {[40, 60, 45, 75, 55, 90, 65, 80, 50, 70, 85, 95, 60, 40].map((h, i) => (
                                                <motion.div
                                                    ...
                                                    className="flex-1 bg-gradient-to-t from-sit-orange/50 to-sit-half-baked/80 rounded-t-sm"
                                                />
                                            ))}
                                        </div>
                    ...
                    <div className="max-w-7xl mx-auto px-6 relative z-10">
                        <div className="grid lg:grid-cols-2 gap-16 items-center">
                            ...
                            <div className="order-1 lg:order-2 space-y-8">
                                <span className="text-sit-half-baked font-black uppercase text-xs tracking-[0.3em] block">Real-time Insights</span>
                                <h2 className="text-4xl md:text-7xl font-black leading-tight">
                                    See the truth, instantly.
                                </h2>
                                <p className="text-xl md:text-2xl text-slate-400 font-medium leading-relaxed">
                                    We designed SIT Manager to turn project data into clear visuals. You don’t need meetings to understand what’s happening. The dashboard tells you everything.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="max-w-7xl mx-auto px-6">
                        <div className="grid lg:grid-cols-2 gap-16 items-center">
                            <div className="space-y-8">
                                ...
                                <p className="text-xl md:text-2xl text-slate-500 dark:text-slate-400 font-medium leading-relaxed">
                                    Everyone is aligned, no reminders needed. We built communication directly into the workflow so you never have to guess who's doing what.
                                </p>
                            </div>
                            <div className="relative group">
                                {/* Visual Representation: The "Collaboration" Chat Bubbles */}
                                <div className="glass-panel p-8 md:p-12 rounded-[3.5rem] border border-sit-orange/10 shadow-2xl relative overflow-hidden bg-white/40 dark:bg-slate-900/40 backdrop-blur-3xl">
                                    <div className="absolute inset-0 bg-gradient-to-br from-sit-orange/5 via-transparent to-sit-half-baked/5" />
                                    ...
                                    <div className="space-y-6 relative z-10">
                                        ...
                                        >
                                            ...
                                            <div className="p-4 rounded-2xl rounded-bl-none bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 shadow-sm max-w-[80%]">
                                                <div className="h-2 w-16 bg-sit-orange/20 dark:bg-sit-orange/30 rounded-full mb-2" />
                                        ...
                                        >
                                            ...
                                            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-sit-orange to-sit-yellow shrink-0" />
                                        </motion.div>
                                        ...
                                        <motion.div
                                            ...
                                            className="p-6 rounded-3xl bg-sit-half-baked/10 dark:bg-sit-half-baked/20 border border-sit-half-baked/30 flex items-center gap-4 group-hover:translate-y-[-5px] transition-transform duration-500"
                                        >
                                            ...
                                            <div className="flex-1">
                                                <div className="h-2 w-32 bg-sit-orange rounded-full mb-2" />
                                                <div className="h-2 w-full bg-sit-orange/20 rounded-full" />
                                            </div>
                                        </motion.div>
                                    </div>
                ...
                <section className="py-24 md:py-32 bg-sit-dark text-white overflow-hidden">
                    <div className="max-w-5xl mx-auto px-6">
                        <div className="grid md:grid-cols-2 gap-16 items-center">
                            <div className="space-y-8">
                                <h2 className="text-4xl md:text-7xl font-black leading-tight">
                                    The Mission of <br /> SIT Manager
                                </h2>
                                <div className="space-y-6 text-xl md:text-2xl opacity-90 font-medium leading-relaxed">
                                    <p>
                                        We are the Shaggar Institute of Technology team, and like many of you, we’ve seen groups where:
                                    </p>
                                    <ul className="space-y-4">
                                        <li className="flex items-center gap-4"><div className="w-2.5 h-2.5 rounded-full bg-sit-orange shrink-0" /> A few people carried the whole project</li>
                                        <li className="flex items-center gap-4"><div className="w-2.5 h-2.5 rounded-full bg-sit-orange shrink-0" /> Deadlines slipped without a word</li>
                                        <li className="flex items-center gap-4"><div className="w-2.5 h-2.5 rounded-full bg-sit-orange shrink-0" /> Accountability turned into personal conflict</li>
                                    </ul>
                                    <p className="pt-4 font-bold">
                                        SIT Manager is our answer. It’s not about control. It’s about fairness, clarity, and excellence.
                                    </p>
                                </div>
                            </div>
                            <div className="aspect-[4/5] bg-white/10 rounded-[2.5rem] md:rounded-[3rem] border border-white/20 flex items-center justify-center p-8 md:p-12 text-center group">
                                ...
                                >
                                    <p className="text-2xl md:text-4xl font-black mb-6 leading-tight">"We built this for the teams who actually show up."</p>
                                    <p className="text-xs md:text-sm font-black uppercase tracking-[0.3em] opacity-60">— Shaggar Institute of Technology</p>
                                </motion.div>
                            </div>
                        </div>
                    </div>
                ...
                <section className="py-24 px-6">
                    <div className="max-w-4xl mx-auto glass-card rounded-[3rem] p-10 md:p-20 text-center border-none shadow-2xl shadow-sit-orange/10 relative overflow-hidden bg-slate-50 dark:bg-white/5 backdrop-blur-xl">
                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-16 mb-20">
                        <div className="col-span-1 md:col-span-2 space-y-8">
                            <Logo />
                            <div className="space-y-4">
                                <p className="text-lg font-black text-slate-900 dark:text-white">Shaggar Institute of Technology</p>
                                <p className="text-slate-500 dark:text-slate-400 max-w-sm leading-relaxed font-bold">
                                    SIT Manager is an institutional platform focused on tools that respect academic effort and reward execution.
                                </p>
                            </div>
                        </div>
                        <div className="space-y-6">
                            <h4 className="font-black text-xs uppercase tracking-[0.3em] text-sit-orange">Product</h4>
                            <ul className="space-y-4 text-sm font-bold text-slate-500 dark:text-slate-400">
                                <li className="hover:text-sit-orange transition-colors cursor-pointer">Features</li>
                                <li className="hover:text-sit-orange transition-colors opacity-50 cursor-not-allowed">Pricing (Coming Soon)</li>
                                <li className="hover:text-sit-orange transition-colors cursor-pointer">Beta Program</li>
                            </ul>
                        </div>
                        <div className="space-y-6">
                            <h4 className="font-black text-xs uppercase tracking-[0.3em] text-sit-orange">Legal</h4>
                            <ul className="space-y-4 text-sm font-bold text-slate-500 dark:text-slate-400">
                                <li className="hover:text-sit-orange transition-colors cursor-pointer">Privacy Policy</li>
                                <li className="hover:text-sit-orange transition-colors cursor-pointer">Terms of Service</li>
                                <li className="hover:text-sit-orange transition-colors cursor-pointer">Security</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className="pt-12 border-t border-slate-200 dark:border-slate-800 flex flex-col md:flex-row justify-between items-center gap-8">
                        <div className="flex items-center gap-4">
                            <div className="w-10 h-10 rounded-xl bg-sit-orange flex items-center justify-center font-black text-white">S</div>
                            <p className="text-sm font-black text-slate-900 dark:text-white uppercase tracking-widest">Shaggar Institute of Technology</p>
                        </div>
                        <p className="text-xs text-slate-400 font-black uppercase tracking-widest">
                            &copy; 2026 SIT Manager. All rights reserved.
                        </p>
                    </div>
                </div>
            </footer>
